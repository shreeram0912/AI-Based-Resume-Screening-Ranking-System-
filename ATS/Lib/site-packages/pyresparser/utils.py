...
def extract_name(nlp_text, matcher):
    ...
    '''
    # Define or retrieve the name pattern
    cs.NAME_PATTERN = [{"IS_TITLE": True, "IS_ALPHA": True}, {"IS_TITLE": True, "IS_ALPHA": True}]

    # Ensure the pattern is wrapped in a list when adding
    matcher.add('NAME', [cs.NAME_PATTERN])  # Wrap the pattern in a list
