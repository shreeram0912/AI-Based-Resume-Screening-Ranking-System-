...
def run():
    img = Image.open('./Logo/logo_1.png')
    ...
    link = '[©Developed by Shreeram Prajapati](https://www.linkedin.com/in/shreeram-prajapati-11255631b)'
    ...
    if choice == 'User':
        ...
        if st.button('Login'):
            if ad_user == 'ram' and ad_password == 'ram123':
                st.success("Welcome Mr Shreeram !")
                # Display Data
                ...
                for column in plot_data.columns:
                    if plot_data[column].dtype == 'object':
